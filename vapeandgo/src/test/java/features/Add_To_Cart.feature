...
Scenario: Add a product to cart
    ...
    And enter sign-in email "tabsyst.nandanat@gmail.com"
    And enter sign-in password "nandhu123"
    And click sign-in
...
Scenario: Attempt to add an out-of-stock product to the cart
    ...
    And select ml
    And click notify me
    And Enter notify email "tabsyst.nandanat@gmail.com"
    And Enter notify number "9998789976"
